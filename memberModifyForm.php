...
<body>
    <?php
        ...
        $marketing_email = $row["email_marketing"];
        $marketing_sms = $row["sms_marketing"];
        $marketing_kakao = $row["kakao_marketing"];
    ...
    <section class="signup_wrap">
        ...
        <form name="signup" action="memberModify.php?id=<?=$userid?>" method="post">
        <div class="signup_form">
            ...
            <section class="form pw_check">
                ...
                <div class="input">
                    <input type="password" name="pw_chk" value="<?=$pw?>" id="pw_chk" 
            ...
            <section class="form email">
                ...
                <div>
                    <div class="email_input">
                        <div class="input">
                            <input type="email" name="email" value="<?=$email1?>" id="email" 
                                    placeholder="이메일 아이디(이메일 계정)">
                        </div>
                        <span> @ </span>
                        <div class="input">
                            <input type="email" name="email_domain" value="<?=$email2?>" id="email_domain" readonly="readonly">
                        </div>
                    </div>
            ...
            <section class="form address">
                ...
                <div class="postnum">
                    <div class="input">
                        <input type="text" name="postnum" value="<?=$postnum?>" id="postnum" 
                ...
                <div class="input">
                    <input type="text" name="detailAdd" value="<?=$detailAdd?>" id="detailAdd"
                            placeholder="상세주소">
                </div>
            </section>
